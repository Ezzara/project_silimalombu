...
<body>
    <nav class="navbar navbar-expand-lg navbar-light sticky-top">
        <a class="navbar-brand text-black font-weight-bold ml-5" href="{{route('welcome')}}"><img class="rounded-circle" src="{{ asset('image/logo.png') }}" alt="" style="width:80px; height:80px;"></a>
