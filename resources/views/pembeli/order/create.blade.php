    ...
    <div class="row">
        ...
        <div class="col-md-5 mt-5" style="border-right: 1px solid gainsboro;">
            ...
            <form action="{{ route('order.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mt-5">
                    <input type="submit" class="btn mx-auto text-white" value="Buat Pesanan"
                        style="background-color:#3E8412"> <a href="" class="mx-auto text-dark">Kembali ke keranjang</a>
                </div>
                ...
                <div class="col-md-5 mt-5">
                    ...
                    <div class="row">
                        <input class="col-sm-9 ml-3 form-control text-left" type="text" id="" placeholder="Kode Promo"> <button
                            class="btn text-white col-sm-2" style="background-color:#3E8412 ;">Pakai</button>
                    </div>
                    ...
                    <input class="form-control text-left" type="text" id=""
                    ...
                    <div class="rounded my-auto p-3" style="background-color: #DDFFC8 ;">
                        ...
                        <img src="bca.png" alt="logo bca" class="mt-2">
